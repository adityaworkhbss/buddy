...
export function getSocketClient() {
    ...
    socketClient.on("connect_error", (error) => {
        // Socket server may not be running - this is expected in development
        // Messages will still work, just without real-time updates
        console.warn("API Socket client connection error (socket server may not be running):", error.message);
    });
